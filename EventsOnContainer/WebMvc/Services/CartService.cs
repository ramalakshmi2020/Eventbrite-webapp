...
namespace WebMvc.Services
{
    public class CartService : ICartService
    {
        ...
        public async Task ClearCart(ApplicationUser user)
        {
            ...
            var cleanBasketUri = Apipaths.EventsBasket.CleanBasket(_remoteServiceBaseUrl, user.Email);
        ...
        public async Task<Cart> GetCart(ApplicationUser user)
        {
            ...
            var getBasketUri = Apipaths.EventsBasket.GetBasket(_remoteServiceBaseUrl, user.Email);
       ...
       public Order MapCartToOrder(Cart cart)
        ...
        public async Task<Cart> UpdateCart(Cart cart)
        {
            ...
            var updateBasketUri = Apipaths.EventsBasket.UpdateBasket(_remoteServiceBaseUrl);
